  ...
  <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
    ...
    <h1 className="mb-5 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Contact Us</h1>
      ...
      <form className='formData space-y-8' ref={form} onSubmit={sendEmail}>
        ...
        <button className="py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800" type="submit" value="Send" >Send</button>
      </form>
      </div>
